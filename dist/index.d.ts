...
declare abstract class Registration<T = any, R extends GenericProvider<T> = GenericProvider> {
    private _value;
    token: Token<T>;
    lifetime: Lifetime;
    provider: any;
    constructor(register: R, lifetime: Lifetime);
...
declare class Register {
    ...
    constructor(registrations?: (Register | Provider<any>)[], isolated?: boolean);
...
declare class Module {
    ...
    private locked;
    scope: Scope | null;
    constructor(registrations?: (Provider<any> | Module)[], isolated?: boolean);
    private lock;
    get providers(): Register;
    resolve<T>(token: Token<T>, scope?: Scope): T;
    injectable(lifetime?: Lifetime): (constructor: Constructor<any>, _: any) => void;
...
declare const injectable: (lifetime?: Lifetime) => (constructor: Constructor<any>, _: any) => void;
...
export { CircularInjectionError, DiError, Disposable, FrozenScopeError, Lifetime, Module, Provider, Scope, Token, TokenNameError, TokenOverwriteError, TokenProvider, UnknownTokenError, dispose, extendModule, globalModule, globalScope, inject, injectable, onDispose, provide, resolve, token };
